...
export default function TestimonialDisplay() {
  ...
  const connectWebSocket = () => {
    ...
    ws.current.onopen = () => {
      console.log('✅ WebSocket connected - Testimonials');
    };

    ws.current.onmessage = (event) => {
      const message = JSON.parse(event.data);
      console.log('📨 WebSocket message - Testimonials:', message);
    ...
    ws.current.onerror = (error) => {
      console.error('❌ WebSocket error - Testimonials:', error);
    };

    ws.current.onclose = () => {
      console.log('🔌 WebSocket disconnected - Testimonials, reconnecting...');
