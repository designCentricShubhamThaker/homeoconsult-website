      ...
      <div className="mx-auto overflow-hidden">
        <div className="flex flex-col md:flex-row gap-6 md:gap-8 p-4 md:p-12">
          ...
          <div className="flex-1 flex flex-col justify-center px-2 md:px-0">
            ...
            <button className="bg-[#147140] hover:bg-teal-800 text-white font-semibold py-2.5 px-5 md:py-3 md:px-6 rounded-full transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105 flex items-center justify-center gap-2 text-sm md:text-base w-fit">
              Know More
